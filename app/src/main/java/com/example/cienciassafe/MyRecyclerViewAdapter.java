 ...
 */
public class MyRecyclerViewAdapter extends RecyclerView.Adapter<ClassroomCardViewHolder> {

    private List<String> classroomList;

    MyRecyclerViewAdapter(List<String> classroomList) {
    ...
    public void onBindViewHolder(@NonNull ClassroomCardViewHolder holder, int position) {
        if (classroomList != null && position < classroomList.size()) {
            ...
            holder.Title.setText(classroom.split(";")[0]);
            if (classroom.split(";")[1].equals("no_info")) {
                holder.SecondaryText.setText(R.string.classroom_no_info);
            } else if (classroom.split(";")[1].equals("empty")) {
                holder.SecondaryText.setText(R.string.classroom_empty);
            } else if (classroom.split(";")[1].equals("almost_empty")) {
                holder.SecondaryText.setText(R.string.classroom_almost_empty);
            } else if (classroom.split(";")[1].equals("almost_full")) {
                holder.SecondaryText.setText(R.string.classroom_almost_full);
            } else if (classroom.split(";")[1].equals("full")) {
                holder.SecondaryText.setText(R.string.classroom_full);
            } else {
                holder.SecondaryText.setText(R.string.classroom_error);
            }
